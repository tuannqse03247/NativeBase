    ...
    _createClass(IconNB, [
        {
            ...
            value: function setIcon(iconType) {
                ...
                switch (iconType) {
                    ...
                    default;
                        break;
                    case "FontAwesome":
                        this.Icon = _FontAwesome2.
                    default;
                        break;
                    case "Foundation":
                        this.Icon = _Foundation2.
                    default;
                        break;
                    case "Ionicons":
                    ...
                    case "MaterialCommunityIcons":
                        this.Icon = _MaterialCommunityIcons2.
                    default;
                        break;
                    case "MaterialIcons":
                        this.Icon = _MaterialIcons2.
                    default;
                        break;
                    case "Octicons":
                        this.Icon = _Octicons2.
                    default;
                        break;
                    case "SimpleLineIcons":
                        this.Icon = _SimpleLineIcons2.
                    default;
                        break;
                    case "Zocial":
                        this.Icon = _Zocial2.
            ...
            value: function render() {
                ...
                return _react2
                    .default
                    .createElement(this.Icon, _extends({
                        ref: function ref(c) {
...
IconNB.propTypes = {
    style: _propTypes2
        .default
        .oneOfType([_propTypes2.default.object, _propTypes2.default.number, _propTypes2.default.array]),
    type: _propTypes2
        .default
        .oneOf([
            "Entypo",
